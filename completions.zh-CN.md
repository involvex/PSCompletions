...
|[dart]()|[**en-US**](/completions/dart/language/en-US.json)<br>[**~~zh-CN(0.01%)~~**](/completions/dart/language/zh-CN.json)||
...
|[dotnet](https://learn.microsoft.com/en-gb/dotnet/core/tools/dotnet)|[**en-US**](/completions/dotnet/language/en-US.json)<br>[**zh-CN(100%)**](/completions/dotnet/language/zh-CN.json)|dotnet - .NET CLI 的通用驱动程序。|
...
|[flutter]()|[**en-US**](/completions/flutter/language/en-US.json)<br>[**~~zh-CN(0.01%)~~**](/completions/flutter/language/zh-CN.json)||
...
|[mysql](https://dev.mysql.com/doc/refman/8.4/en/mysql-command-options.html)|[**en-US**](/completions/mysql/language/en-US.json)<br>[**zh-CN(1.53%)**](/completions/mysql/language/zh-CN.json)|MySQL 命令行客户端|
...
|[pnpm](https://pnpm.io/zh/)|[**en-US**](/completions/pnpm/language/en-US.json)<br>[**zh-CN(86.54%)**](/completions/pnpm/language/zh-CN.json)|pnpm - 软件包管理器。|
...
|[psc](https://pscompletions.abgox.com)|[**en-US**](/completions/psc/language/en-US.json)<br>[**zh-CN(100%)**](/completions/psc/language/zh-CN.json)|PSCompletions 模块的补全<br>如果移除它，将会自动重新添加|
...
|[ya](https://yazi-rs.github.io/)|[**en-US**](/completions/ya/language/en-US.json)<br>[**zh-CN(100%)**](/completions/ya/language/zh-CN.json)|Yazi - 一款基于异步 I/O、用 Rust 编写的超快速终端文件管理器。|
...
|[yazi](https://yazi-rs.github.io/)|[**en-US**](/completions/yazi/language/en-US.json)<br>[**zh-CN(100%)**](/completions/yazi/language/zh-CN.json)|Yazi - 一款基于异步 I/O、用 Rust 编写的超快速终端文件管理器。|
